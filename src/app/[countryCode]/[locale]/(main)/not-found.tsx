...
export default async function NotFound({ params }: { params: { locale: Locale } }) {
  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center min-h-[calc(100vh-64px)] bg-white">
      ...
      <InteractiveLink href="/" className="mt-4">
        {dictionary.error.goToFrontpage}
      </InteractiveLink>
    </div>
  )
}
