...
const benefits = [
  ...
  },
  {
    ...
    title: "UV Protection",
    description: "Integrated UPF 50+ protection shields your skin from harmful rays during long days on the course."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10">
      ...
      <div className="content-container">
        <div className="text-center mb-12">
          <h2 className="font-display text-3xl md:text-4xl text-nxl-gold uppercase tracking-wider mb-4">
            The Next X Level Advantage
          </h2>
          <p className="font-body text-nxl-ivory/80 max-w-xl mx-auto">
            Our commitment to quality, performance, and style sets us apart
          </p>
        </div>
